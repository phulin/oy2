...
This Privacy Notice for Patrick Hulin ("we," "us," or "our" ), describes
...
- Visit our website at oyme.site or any website of ours that links to
  this Privacy Notice

- Download and use our mobile application (Oy) , or any other
...
is by visiting contact@oyme.site , or by contacting us. We will consider
...
will treat this as a valid request to opt out of the sale or sharing of
your personal information for targeted advertising purposes under
applicable state privacy laws, including the California Consumer Privacy
Act (CCPA). When we detect a GPC signal from your browser, we will
automatically apply your opt-out preference without requiring you to
take any additional action. For more information about GPC and how to
enable it, visit globalprivacycontrol.org.
...
+=======================+=======================+:=====================:+
| A. Identifiers        | Contact details, such | YES                   |
|                       | as real name, alias,  |                       |
|                       | postal address,       |                       |
|                       | telephone or mobile   |                       |
|                       | contact number,       |                       |
...
+-----------------------+-----------------------+:---------------------:+
| B. Personal           | Name, contact         | YES                   |
| information as        | information,          |                       |
| defined in the        | education,            |                       |
| California Customer   | employment,           |                       |
...
+-----------------------+-----------------------+:---------------------:+
| C . Protected         | Gender, age, date of  | NO                    |
| classification        | birth, race and       |                       |
| characteristics under | ethnicity, national   |                       |
| state or federal law  | origin, marital       |                       |
|                       | status, and other     |                       |
|                       | demographic data      |                       |
+-----------------------+-----------------------+-----------------------+
| D . Commercial        | Transaction           | NO                    |
| information           | information, purchase |                       |
|                       | history, financial    |                       |
|                       | details, and payment  |                       |
|                       | information           |                       |
+-----------------------+-----------------------+-----------------------+
| E . Biometric         | Fingerprints and      | NO                    |
| information           | voiceprints           |                       |
+-----------------------+-----------------------+-----------------------+
| F . Internet or other | Browsing history,     | NO                    |
| similar network       | search history,       |                       |
| activity              | online behavior ,     |                       |
|                       | interest data, and    |                       |
...
+-----------------------+-----------------------+-----------------------+
| H . Audio,            | Images and audio,     | NO                    |
| electronic, sensory,  | video or call         |                       |
| or similar            | recordings created in |                       |
| information           | connection with our   |                       |
|                       | business activities   |                       |
+-----------------------+-----------------------+-----------------------+
| I . Professional or   | Business contact      | NO                    |
| employment-related    | details in order to   |                       |
| information           | provide you our       |                       |
|                       | Services at a         |                       |
...
|                       | us                    |                       |
+-----------------------+-----------------------+-----------------------+
| J . Education         | Student records and   | NO                    |
| Information           | directory information |                       |
+-----------------------+-----------------------+-----------------------+
| K . Inferences drawn  | Inferences drawn from | NO                    |
| from collected        | any of the collected  |                       |
...
contact@oyme.site , by emailing us at contact@oyme.site , or by
...
us at contact@oyme.site . We will inform you in writing of any action
...
information, please email contact@oyme.site.
